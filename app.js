        ...
        <div class="glance-content-col">
          <div>
            <div class="glance-card-header">
              ...
              ${cs.subheadline ? `<div class="glance-project-subquote" style="font-family: 'Playfair Display', Georgia, serif; font-style: italic; font-size: 13px; color: #9B5620; opacity: 0.9; margin-top: -2px; margin-bottom: 28px;">${cs.subheadline}</div>` : ''}
